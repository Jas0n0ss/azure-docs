![](https://techcommunity.microsoft.com/t5/image/serverpage/image-id/432861i12275A92C6917596/image-dimensions/2000?v=v2&px=-1)
...
- Setup guide: https://docs.microsoft.com/en-us/azure/openshift/tutorial-create-cluster
...
[Connect to an Azure Red Hat OpenShift cluster](https://docs.microsoft.com/en-us/azure/openshift/tutorial-connect-cluster)
...
[Create-the-custom-resource-definitions](https://docs.microsoft.com/en-us/azure/azure-arc/data/create-data-controller-using-kubernetes-native-tools#create-the-custom-resource-definitions)
...
[Create the bootstrapper service](https://docs.microsoft.com/en-us/azure/azure-arc/data/create-data-controller-using-kubernetes-native-tools#create-the-bootstrapper-service)
...
[Create secrets for the metrics and logs dashboards](https://docs.microsoft.com/en-us/azure/azure-arc/data/create-data-controller-using-kubernetes-native-tools#create-secrets-for-the-metrics-and-logs-dashboards)
...
[Create the webhook deployment job, cluster role and cluster role binding](https://docs.microsoft.com/en-us/azure/azure-arc/data/create-data-controller-using-kubernetes-native-tools#create-the-webhook-deployment-job-cluster-role-and-cluster-role-binding)
...
[Create the data controller](https://docs.microsoft.com/en-us/azure/azure-arc/data/create-data-controller-using-kubernetes-native-tools#create-the-data-controller)
...
#### Create Azure Arc-enabled SQL Managed Instance with Kubernetes
